...
`,le=ae,ue={default:oe,grace:se,simple:ce},de=[{label:`经典`,value:`default`,desc:``},{label:`优雅`,value:`grace`,desc:`@brzhang`},{label:`简洁`,value:`simple`,desc:`@okooo5km`}],fe=[{label:`无衬线`,value:`-apple-system-font,BlinkMacSystemFont, Helvetica Neue, PingFang SC, Hiragino Sans GB , Microsoft YaHei UI , Microsoft YaHei ,Arial,sans-serif`,desc:`字体123Abc`},{label:`衬线`,value:`Optima-Regular, Optima, PingFangSC-light, PingFangTC-light, 'PingFang SC', Cambria, Cochin, Georgia, Times, 'Times New Roman', serif`,desc:`字体123Abc`},{label:`等宽`,value:`Menlo, Monaco, 'Courier New', monospace`,desc:`字体123Abc`}],h=[{label:`14px`,value:`14px`,desc:`更小`},{label:`15px`,value:`15px`,desc:`稍小`},{label:`16px`,value:`16px`,desc:`推荐`},{label:`17px`,value:`17px`,desc:`稍大`},{label:`18px`,value:`18px`,desc:`更大`}],g=[{label:`经典蓝`,value:`#0F4C81`,desc:`稳重冷静`},{label:`翡翠绿`,value:`#009874`,desc:`自然平衡`},{label:`活力橘`,value:`#FA5151`,desc:`热情活力`},{label:`柠檬黄`,value:`#FECE00`,desc:`明亮温暖`},{label:`薰衣紫`,value:`#92617E`,desc:`优雅神秘`},{label:`天空蓝`,value:`#55C9EA`,desc:`清爽自由`},{label:`玫瑰金`,value:`#B76E79`,desc:`奢华现代`},{label:`橄榄绿`,value:`#556B2F`,desc:`沉稳自然`},{label:`石墨黑`,value:`#333333`,desc:`内敛极简`},{label:`雾烟灰`,value:`#A9A9A9`,desc:`柔和低调`},{label:`樱花粉`,value:`#FFB7C5`,desc:`浪漫甜美`}],pe=[{label:`移动端`,value:`w-[375px]`,desc:`固定`},{label:`电脑端`,value:`w-full`,desc:`适应`}],me=`https://s4.zstatic.net/ajax/libs/highlight.js/11.11.1/styles/`,he=`1c-light.a11y-dark.a11y-light.agate.an-old-hope.androidstudio.arduino-light.arta.ascetic.atom-one-dark-reasonable.atom-one-dark.atom-one-light.brown-paper.codepen-embed.color-brewer.dark.default.devibeans.docco.far.felipec.foundation.github-dark-dimmed.github-dark.github.gml.googlecode.gradient-dark.gradient-light.grayscale.hybrid.idea.intellij-light.ir-black.isbl-editor-dark.isbl-editor-light.kimbie-dark.kimbie-light.lightfair.lioshi.magula.mono-blue.monokai-sublime.monokai.night-owl.nnfx-dark.nnfx-light.nord.obsidian.panda-syntax-dark.panda-syntax-light.paraiso-dark.paraiso-light.pojoaque.purebasic.qtcreator-dark.qtcreator-light.rainbow.routeros.school-book.shades-of-purple.srcery.stackoverflow-dark.stackoverflow-light.sunburst.tokyo-night-dark.tokyo-night-light.tomorrow-night-blue.tomorrow-night-bright.vs.vs2015.xcode.xt256`.split(`.`).map(e=>({label:e,value:`${me}${e}.min.css`,desc:``})),ge=[{label:`一级标题`,value:`h1`,desc:``},{label:`二级标题`,value:`h2`,desc:``},{label:`三级标题`,value:`h3`,desc:``},{label:`四级标题`,value:`h4`,desc:``},{label:`五级标题`,value:`h5`,desc:``},{label:`六级标题`,value:`h6`,desc:``}],_e=[{label:`默认`,value:`default`,desc:``},{label:`主题色文字`,value:`color-only`,desc:``},{label:`下边框`,value:`border-bottom`,desc:``},{label:`左边框`,value:`border-left`,desc:``},{label:`自定义`,value:`custom`,desc:``}],ve={},ye=[{label:`title 优先`,value:`title-alt`,desc:``},{label:`alt 优先`,value:`alt-title`,desc:``},{label:`只显示 title`,value:`title`,desc:``},{label:`只显示 alt`,value:`alt`,desc:``},{label:`文件名`,value:`filename`,desc:``},{label:`不显示`,value:`none`,desc:``}],_={isCiteStatus:!1,isMacCodeBlock:!0,isShowLineNumber:!1,isCountStatus:!1,theme:de[0].value,fontFamily:fe[0].value,fontSize:h[2].value,primaryColor:g[0].value,codeBlockTheme:he[23].value,legend:ye[3].value,headingStyles:ve};function be(){return{primaryColor:_.primaryColor,fontFamily:_.fontFamily,fontSize:_.fontSize,codeBlockTheme:_.codeBlockTheme,headingStyles:{..._.headingStyles},isShowLineNumber:_.isShowLineNumber,isMacCodeBlock:_.isMacCodeBlock}}function v(e){return`${p}__${e}`}var xe=`doocs-md`,y=`documents`,b=`settings`,x=`secrets`,S=`cache`,C=`meta`,Se=v(`storage_migrated_v1`),w=v(`storage_localstorage_cleaned_v1`),Ce=`${p}__`,we=new Set([`isCiteStatus`,`isCountStatus`,`legend`,`previewWidth`,`showAIToolbox`,`viewMode`,`previewDevice`,`locale`,`openai_type`,`openai_temperature`,`openai_max_token`,`quick_commands`,`imgHost`,`useCompression`,`isShowCssEditor`,`hasShownAIToolboxHint`,`isMobile`,`formCustomConfig`]);v(`current_post_id`),v(`sort_mode`);var T=v(`posts`),Te=[`Config`],Ee=[`openai_key_`,`openai_model_`,`openai_image_key_`,`openai_image_endpoint_`,`openai_image_model_`,`mpToken:`],De=new Set([`uploaded_image_map`,`ai_generated_images`,`ai_image_timestamps`,`ai_image_prompts`,`ai_memory_context`,`ai_conversation_list`]),Oe=[`ai_conversation_`];function ke(e){return Te.some(t=>e.endsWith(t))?!0:Ee.some(t=>e.startsWith(t))}function E(e){return De.has(e)?!0:Oe.some(t=>e.startsWith(t))}function D(e){return ke(e)?x:E(e)?S:b}var O=[`fonts`,`size`,`color`,`codeBlockTheme`,`headingStyles`,`isMacCodeBlock`,`isShowLineNumber`];function Ae(e){return!!(e.startsWith(Ce)||O.includes(e)||we.has(e)||ke(e)||E(e))}var k=v(`legacy_migrated`),A=v(`theme`),j=v(`themeSettings`),M=v(`mp_profile_migrated`),N=null;function P(){return N||=t(xe,2,{upgrade(e){if(!e.objectStoreNames.contains(y)){let t=e.createObjectStore(y,{keyPath:`id`});t.createIndex(`updateDatetime`,`updateDatetime`),t.createIndex(`parentId`,`parentId`)}e.objectStoreNames.contains(b)||e.createObjectStore(b,{keyPath:`key`}),e.objectStoreNames.contains(x)||e.createObjectStore(x,{keyPath:`key`}),e.objectStoreNames.contains(S)||e.createObjectStore(S,{keyPath:`key`}),e.objectStoreNames.contains(C)||e.createObjectStore(C,{keyPath:`key`})}}),N}async function F(e){return(await(await P()).get(C,e))?.value??null}async function I(e,t){await(await P()).put(C,{key:e,value:t})}var je=`locale`,L=`zh-CN`,Me=[`zh-CN`,`en-US`],Ne=[{value:`zh-CN`,labelKey:`locale.zhCN`},{value:`en-US`,labelKey:`locale.enUS`}],Pe={toolbar:{expand:`Expand AI toolbar`,openToolboxHint:`Click to open AI toolbox`,assistant:`AI Assistant`,assistantLabel:`Assistant`,imageGen:`AI Image Gen`,imageGenLabel:`Image`,toolbox:`AI Toolbox`,toolboxLabel:`Toolbox`},chat:{title:`AI Chat`,configParams:`Settings`,imageGen:`AI Image Gen`,newSession:`New session`,loadConversation:`Load conversation`,clearConversation:`Clear conversation`,description:`Use AI to help you write and refine content`,noSavedConversations:`No saved conversations`,noQuickCommands:`No quick commands yet. Click + to add one.`,manageCommands:`Manage commands`,greeting:`Hi, I'm your AI assistant. How can I help?`,conversationTitle:`Chat {date}`,sessionCreated:`New session created`,conversationLoaded:`Conversation loaded`,conversationDeleted:`Conversation deleted`,insertedToDoc:`Inserted into document`,sessionCleared:`Session cleared`,thinking:`Thinking…`,copyContent:`Copy content`,insertDoc:`Insert into document`,regenerate:`Regenerate`,inputPlaceholder:`Say something… (Enter to send, Shift+Enter for new line)`,quoteFullText:`Quote full text`,pause:`Pause`,send:`Send`,requestFailed:`❌ Request failed: {message}`,systemQuote:`Below is the full Markdown article. Follow it strictly for subsequent instructions:
